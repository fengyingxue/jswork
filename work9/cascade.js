...
var mojorSelect = document.getElementById('mojorSelect');
collegeSelect.onchange = function(){
    mojorSelect.options.length = 0;
    createOption(mojorSelect,majors[collegeSelect.value]);
};

var classSelect = document.getElementById('classSelect');
mojorSelect.onchange = function(){
    classSelect.options.length = 0;
    createOption(classSelect,classes[collegeSelect.value][mojorSelect.value]);
};
